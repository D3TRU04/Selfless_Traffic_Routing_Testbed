...
def addGenericOptions(argParser):
    ...
    argParser.add_argument("-dp", "--directory_plus", default="", type=str,dest="dPlus",
                            help="Additional directory destination added to current directory generated from os.getcwd()")
...
def main(args=None):
    ...
    for step in range(options.firstStep, options.lastStep):
        ...
        current_directory = os.path.join(current_directory,options.dPlus)
        final_directory = os.path.join(current_directory, str(step))
        print("final countdown:",final_directory)
