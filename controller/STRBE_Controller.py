...
class NewPolicy_Reader_STRBE(RouteController):
    #BE as in before execution
    def get_edges(self,vehicle,connection_info,d_list): # input directions get a set of edges
        e_list = []
    ...
    #est_travel_time2 = {}
    def get_directions(self,connection_info,c_list): # input a set of edges get directions back
    ...
    def __init__(self, connection_info,file_name,file_name2,Round_name,vehicles,start_difference,predictors):
        ...
        self.edge_swapped_dict= {} #is of form {edge_id:{destination:listofvehicles}} that being vehicles who swap on the edge_id
        ...
        # by default this the Dijkstra's routes
        ...
        # by default this is the DUE approxmated 100 iterations routes.
        ...
        #setting up route information which is used as input for the predictors
        ...
        for x in self.nu_trips.keys():  
            ...
            #print()
            self.route_information[x] =[vehicles[x].start_time,self.est_travel_time[x],self.sharing_route[x],self.distance_route[x]] #self.num_edges[x],
        #print("working 1")
            #print(vid," : ", root )
        ...
        #sorting everything into edge_swapped_dict of form {edge_id:{destination:listofvehicles}}
        unique = []
        ...
        #sorting all vehicles by deadline in ascending order
        for x in vehicles:
        ...
        #the meat, this is point 6 in the algorithm, here we are seeing what can be swapped with.
        for current in vid_by_deadline:
            ...
            for y in self.nu_trips[current]:
                ...
                if y in self.edge_swapped_dict.keys(): # shared edges
                    #the_edge = y
                    ...
                    if the_dest in self.edge_swapped_dict[y].keys():
                        ...
                        for considering in self.edge_swapped_dict[y][the_dest]:
                            ...
                            if self.base_trips[current] == self.base_trips[considering]:
                                ...
                                temp_route = self.nu_trips[current][:current_idx]#+1]# do not include shared edge as the next line will get that for us
                                temp_route.extend(self.nu_trips[considering][considering_idx:])
                                
                                # print("checking the route:")
                                # print("vehicle:",current," vs vehicle:",considering)
                                # print("Shared Edge:",str(y))
                                # print("current",self.nu_trips[current])
                                # print("considering:",self.nu_trips[considering])
                                # print("current up to index:",self.nu_trips[current][:current_idx+1])
                                # print("considering after index:",self.nu_trips[considering][considering_idx:])
                                # print("proposed route:",temp_route)
                                # print()
                                #print("AAAAA WHAY",x2)
                                ...
                                temp_trip_info =[vehicles[considering].start_time,temp_est_travel_time,temp_sharing_route,temp_distance_route] #temp_num_edges,
            ...
            for y2 in edges_and_predictions.keys():
                ...
                # making sure that I don't reroute a vehicle away from a good route
            ...
            if veh_to_swap != -1:
                ...
                for x2 in [current,considering]:#self.nu_trips.keys():  
                    ...
                    self.route_information[x2] =[vehicles[x2].start_time,self.est_travel_time[x2],self.sharing_route[x2],self.distance_route[x2]]#self.num_edges[x2],
    ...
    def make_decisions(self, vehicles, connection_info):
        ...
        for vehicle in vehicles:
            if vehicle.vehicle_id not in self.routes.keys():
                ...
                #I believe I do this so that I can check what 
